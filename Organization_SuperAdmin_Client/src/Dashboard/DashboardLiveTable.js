...
const Table = () => {
  ...
  return (
    <div style={{marginRight:'0px',width:'84.5%' }} className="container-sm  ">
      <div className="header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '40px' }}>
        <h4 style={{ marginTop: '6%', marginLeft: '2%', fontWeight: 'bold' }}>Live Appointment </h4>
      ...
      <table className="dashboard-table">
          <thead style={{ border: "1px solid rgb(235, 233, 233)", color: '#B5B5C3', borderColor: '#FAFAFA',fontSize:'10px' }}>
            <br></br>
            <tr>
              <th style={{textAlign:'center',fontSize:'14px',color: '#B5B5C3', backgroundColor: '#FAFAFA' ,fontWeight:'bold'}}>Organization Name</th>
              <th style={{textAlign:'center',fontSize:'14px',color: '#B5B5C3', backgroundColor: '#FAFAFA' ,fontWeight:'bold'}}>Status</th>
              <th style={{textAlign:'center',fontSize:'14px',color: '#B5B5C3', backgroundColor: '#FAFAFA' ,fontWeight:'bold'}}>Consulting ID</th>
              <th style={{textAlign:'center',fontSize:'14px',color: '#B5B5C3', backgroundColor: '#FAFAFA' ,fontWeight:'bold'}}>Patient Name</th>
            
              <th style={{textAlign:'center',fontSize:'14px',color: '#B5B5C3', backgroundColor: '#FAFAFA' ,fontWeight:'bold'}}>Sick Type</th>
              <th style={{textAlign:'center',fontSize:'14px',color: '#B5B5C3', backgroundColor: '#FAFAFA' ,fontWeight:'bold'}}>Assignee</th>
              <th style={{textAlign:'center',fontSize:'14px',color: '#B5B5C3', backgroundColor: '#FAFAFA' ,fontWeight:'bold'}}>Date & Time</th>
              <th style={{textAlign:'center',fontSize:'14px',color: '#B5B5C3', backgroundColor: '#FAFAFA' ,fontWeight:'bold'}}>View</th>
              <th style={{textAlign:'center',fontSize:'14px',color: '#B5B5C3', backgroundColor: '#FAFAFA' ,fontWeight:'bold'}}>Edit</th>
              <th style={{textAlign:'center',fontSize:'14px',color: '#B5B5C3', backgroundColor: '#FAFAFA' ,fontWeight:'bold'}}>Delete</th>
            </tr>
          </thead>
