...
function Buyplan() {
  ...
  return (
    <div className="container-fluid" style={{marginTop:'80px',marginLeft:'115px',width:'90%',backgroundColor:'white'}}>

        <h4 className="text-center plan-subscription">
        Our plan Details for your   </h4>
      <h3 className="text-primary text-center" style={{marginTop:'10px'}}>Organization</h3>
        ...
        <div
          ...
          >
            ...
            <p className="card-texts ml-2" style={{fontSize:'13px'}}>
              ...
              <h2 className="card-title ml-2 heading" style={{ fontSize: '50px', whiteSpace: 'nowrap' }}>
  ₹299 
  <span className="per-month heading" style={{ fontWeight: 'normal', fontSize: '16px', marginLeft: '5px', marginTop: '20px', display: 'inline-block', verticalAlign: 'top',paddingBottom:'30px'  }}>
    / Month
  </span>
</h2>
    ...
    <img src={check} alt="check icon"  className="checkicons"/><span className="ml-3 payment">Unique Access ID</span>
                ...
                <button
        type="button"
        className="btn btn-primary getstart"
        style={{ backgroundColor: 'white', color: 'blue', width: '90%', marginRight:'20px' }}
  ...
  <span className="per-month heading" style={{ fontWeight: 'normal', fontSize: '16px', marginLeft: '5px', marginTop: '20px', display: 'inline-block', verticalAlign: 'top',paddingBottom:'30px'  }}>
    / Month
                ...
                <div class="d-flex justify-content-center">
  <button type="button" class="btn btn-primary" style={{backgroundColor: 'white', color: 'blue', width: '90%', marginRight:'20px'}}>Get Started Now</button>
</div>
        ...
        <div
          ...
          >
            ...
            <h6 style={{fontWeight:'650'}}> PREMIUM</h6>
              ...
              <h2 className="card-title ml-2 heading" style={{ fontSize: '50px', whiteSpace: 'nowrap'  ,paddingBottom:'30px' }}>
  ₹499 
  <span className="per-month heading" style={{ fontWeight: 'normal', fontSize: '16px', marginLeft: '5px', marginTop: '20px', display: 'inline-block', verticalAlign: 'top' }}>
    / Month
  </span>
</h2>              
                ...
                <div class="d-flex justify-content-center">
  <button type="button" class="btn btn-primary" style={{backgroundColor: 'white', color: 'blue', width: '90%', marginLeft:'-20px'}}>Get Started Now</button>
</div>
